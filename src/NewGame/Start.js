...
const Start = () => {
  ...
  return (
    <section className="column">
      <p>You have 1 minute to guess as many hate-symbols as you can. Each correct answer will take you to the next card, while incorrect answers will flip the card to allow you to learn about that symbol before moving on.</p>
